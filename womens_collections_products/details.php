      ...
      <ul class="navmenu">
        ...
        <li>
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="/fashionwear/womens_collections_products/index.php">Women's Collection</a></li>
            <li><a href="/fashionwear/kids_collections_products/index.php">Kid's Collection</a></li>
          </ul>
        </li>
    ...
    <section class="contact">
      <div class="contact-info">
        <div class="first-info info">
          <a href="index.php">
            <img src="/fashionwear/images/logo.png" width="80" class="footer-image" height="80" alt="FashionWear Logo" />
          </a>
          <ul>
            <li>
              <p>Kathmandu, Nepal</p>
