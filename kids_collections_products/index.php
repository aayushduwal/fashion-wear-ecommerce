...
<head>
  ...
  <title>Kids' Collection - FashionWear</title>
...
<body>
  <style>
  .hero {
    background: url("https://www.modsandminis.ie/wp-content/uploads/2022/07/blog_banner.jpg") no-repeat center center/cover;
    height: 60vh;
    display: flex;
